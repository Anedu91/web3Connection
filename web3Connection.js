...
const abiContract = [
  ...
  },
  {
    ...
    name: "mintNFT", // funcion de minteo.
    outputs: [],
    stateMutability: "payable",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "", type: "address" }],
    name: "reserveListPreSaleCounter",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      { internalType: "uint256", name: "reservedTokens", type: "uint256" },
    ],
    name: "reserveNFT",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      {
        internalType: "address",
        name: "_newAdminClaimeCars",
        type: "address",
      },
    ],
    name: "setAdminClaimCars",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
async function fetchAccountData() {
  ...
  // console.log(
  new web3Instance.eth.Contract(JSON.stringify(abiContract), CONTRACT_ADDRESS);
  // );
